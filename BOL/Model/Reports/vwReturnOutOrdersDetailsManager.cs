...
namespace BOL
{
    public class vwReturnOutOrdersDetailsManager : Repository<vwReturnOutOrdersDetails>
    {

        public vwReturnOutOrdersDetailsManager(GPFAssetsEntities ctx) : base(ctx)
        {

        }


        public List<vwReturnOutOrdersDetails> GetNotDelAllByParam(DateTime? FromDate, DateTime? Todate
         , long? StoreId, long? ItemId, int? CatMain_Id)
        {
            ...
            List<vwReturnOutOrdersDetails> List;
        ...
        public List<vwReturnOutOrdersDetails> GetNotDelByOrderId(long? ReturnOrderId)
        {
            //stu => stu.CarNo.ToUpper().Contains(Search_Data.ToUpper()) || stu.CarType.ToUpper().Contains(Search_Data.ToUpper()));
            List<vwReturnOutOrdersDetails> List;
            //DbFunctions.TruncateTime(c.OutOrders.OutOrderDate) >= DbFunctions.TruncateTime(FromDate) && DbFunctions.TruncateTime(c.OutOrders.OutOrderDate) <= DbFunctions.TruncateTime(Todate)
        ...
        //public List<vwReturnOutOrdersDetails> GetAllDetails(List<vwReturnOutOrdersDetails> List)
        //{
