...
namespace BOL
{
    public class ChangeQuantityOrdersViewModel
    {
        public ChangeQuantityOrdersViewModel()
        {
            ItemsScanCheckList = new List<CheckBoxListItem>();
            ChangeQuantityOrdersDetails = new List<ChangeQuantityOrdersDetails>();
        }
        public int Size_Of_Page = 15;
        public int No_Of_Page = 1;
        private UnitOfWork unitWork = new UnitOfWork();

        public PagedList.IPagedList<ChangeQuantityOrders> ChangeQuantityOrders { get; set; }
        public List<ChangeQuantityOrdersDetails> ChangeQuantityOrdersDetails { get; set; }
        public List<tbl_ItemsStock> ScanItems { get; set; }

        public ChangeQuantityOrders SelectedItem { get; set; }
