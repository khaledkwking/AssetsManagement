...
namespace BOL
{
    public class ReturnOutOrdersViewModel
    {
        public ReturnOutOrdersViewModel()
        {
            ItemsScanCheckList = new List<CheckBoxListItem>();
            ReturnOutOrdersDetails = new List<ReturnOutOrdersDetails>();
        }
        public int Size_Of_Page = 15;
        public int No_Of_Page = 1;
        private UnitOfWork unitWork = new UnitOfWork();

        public PagedList.IPagedList<ReturnOutOrders> ReturnOutOrders { get; set; }
        public List<ReturnOutOrdersDetails> ReturnOutOrdersDetails { get; set; }
        public List<tbl_ItemsStock> ScanItems { get; set; }

        //public OutOrders OutOrders { get; set; }

        public ReturnOutOrders SelectedItem { get; set; }
