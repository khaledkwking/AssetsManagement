...
namespace BOL
{
    public class OutOrdersViewModel
    {
        public OutOrdersViewModel()
        {
            ItemsScanCheckList = new List<CheckBoxListItem>();
            OutOrdersDetails = new List <OutOrdersDetails>();
        }
        public int Size_Of_Page = 15;
        public int No_Of_Page = 1;
        private UnitOfWork unitWork = new UnitOfWork();

        public PagedList.IPagedList<OutOrders> OutOrders { get; set; }
        public List <OutOrdersDetails> OutOrdersDetails { get; set; }
