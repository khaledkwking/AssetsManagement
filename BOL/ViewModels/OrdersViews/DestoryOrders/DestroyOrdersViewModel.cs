...
namespace BOL
{
    public class DestroyOrdersViewModel
    {
        public DestroyOrdersViewModel()
        {
            ItemsScanCheckList = new List<CheckBoxListItem>();
            DestroyOrdersDetails = new List <DestroyOrdersDetails>();
        }
        public int Size_Of_Page = 15;
        public int No_Of_Page = 1;
        private UnitOfWork unitWork = new UnitOfWork();

        public PagedList.IPagedList<DestroyOrders> DestroyOrders { get; set; }
        public List <DestroyOrdersDetails> DestroyOrdersDetails { get; set; }
        public List <tbl_ItemsStock> ScanItems { get; set; }
       
        public DestroyOrders SelectedItem { get; set; }
