...
namespace BOL
{
    public class InOrdersViewModel
    {
        public InOrdersViewModel()
        {
            ItemsScanCheckList = new List<CheckBoxListItem>();
            InOrdersDetails = new List<InOrdersDetails>();
        }
        public int Size_Of_Page = 15;
        public int No_Of_Page = 1;
        private UnitOfWork unitWork = new UnitOfWork();

        public PagedList.IPagedList<InOrders> InOrders { get; set; }
        public List<InOrdersDetails> InOrdersDetails { get; set; }
        public List<tbl_ItemsStock> ScanItems { get; set; }

        public InOrders SelectedItem { get; set; }
        ...
        //public List<CheckBoxListItem> ContractSelectList { get; set; }
