...
namespace BOL
{
    public class RequestOutOrdersViewModel
    {
        public RequestOutOrdersViewModel()
        {
            //ItemsScanCheckList = new List<CheckBoxListItem>();
            //RequestOutOrdersDetails = new List <RequestOutOrdersDetails>();
        }
        public int Size_Of_Page = 15;
        public int No_Of_Page = 1;
        private UnitOfWork unitWork = new UnitOfWork();

        public PagedList.IPagedList<RequestOutOrders> RequestOutOrders { get; set; }
        public List <RequestOrdersDetails> RequestOrdersDetails { get; set; }
        public List <tbl_ItemsStock> ScanItems { get; set; }
       
        public RequestOutOrders SelectedItem { get; set; }
        ...
        public long? SelItemId { get; set; }
        public int? SelQty { get; set; }

        public IEnumerable<SelectListItem> DeptsList { get; set; }
        ...
        public DateTime? CurOrderDate { get; set; }
        ...
        //            defaultDeptId = allEmployees.Select(m => m.Department_Id).FirstOrDefault();
        //        }
