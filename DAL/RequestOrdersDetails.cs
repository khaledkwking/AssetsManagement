...
public partial class RequestOrdersDetails
{

    public long ReqOrderDetId { get; set; }

    public Nullable<long> ReqOrderId { get; set; }
    ...
    public Nullable<bool> MasterItemFalg { get; set; }



    public virtual RequestOutOrders RequestOutOrders { get; set; }
